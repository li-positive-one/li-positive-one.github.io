...
![image-20200529000701901](../images/2020-05-28 Friday/image-20200529000701901.png)

网络结构如下图，可以看到其中的分割器S是U-Net结构的。然后还用了多尺度的Loss等Trick.

![image-20200529000701901](../images/2020-05-28 Friday/image-20200528235726324.png)

## 实验结果

作者主要展示的是在某个数据集上训练，在其他数据集上测试，PASS方法相对而言，优势还是很明显的。

![image-20200529004442052](../images/2020-05-28 Friday/image-20200529004442052.png)
